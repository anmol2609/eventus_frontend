        ...
        <>
            ...
            <CRow className="mx-2 my-4">
              <CForm>
                ...
                <div className="d-grid gap-2">
                  <CButton size="sm" type="button" color="primary" onClick={handleFilter}>
                    Filter
                  </CButton>
                </div>
              </CForm>
          ...
          >
            ...
            <CButton
              ...
              className="mr-3"
              color="light"
              onClick={() => navigate('/soar_products/new')}
            >
              New
            </CButton>
          </div>
                        ...
                        <CTableRow key={product._id}>
                          ...
                          <CTableDataCell>
                            <CButton
                              ...
                              color="primary"
                              variant="outline"
                              onClick={() => navigate(`/soar_products/${product._id}/edit`)}
                            >
                              Edit
                            </CButton>
                          </CTableDataCell>
...
export default SOARProductList
